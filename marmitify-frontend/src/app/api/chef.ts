...
export async function registrarChef(description: string, address: string, phone: string, email: string) {
  try {
...
export async function atualizarChef(id: number, description: string, endereco: string, telefone: string) {
  try {
